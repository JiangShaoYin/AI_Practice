...
def backward():
    x = tf.placeholder(tf.int32, [None, None]) #输入2维数据，第1维度是batch, 第2维是句长 [batch_size, seqlen],
    ...
    y_ = tf.placeholder(tf.int32, [None, None]) #标签，第1维度是batch, 第2维是句长 [batch_size, seqlen]
